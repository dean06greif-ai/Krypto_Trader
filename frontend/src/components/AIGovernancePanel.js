...
import { fmtBerlinShort } from '../lib/time';
  ...
  return (
    <div className="gov-panel" data-testid="ai-governance-panel">
      <div className="gov-head">
        ...
        <span className="gov-meta">v{snap.version}{snap.updated_at ? ` · ${fmtBerlinShort(snap.updated_at)}` : ''}</span>
      </div>
      ...
      <div className="gov-rules">
        <label>
          ...
          <input type="number" min="0" max="125" value={rules.max_leverage}
