                    ...
                    {guard?.state?.paused && (
                      <div className="guard-alert-row" data-testid="guard-alert-killswitch">
                        <span>
                          ...
                          <br />
                          <small>
                            pausiert bis {new Date(guard.state.paused_until).toLocaleString('de-DE')} – danach automatisch wieder aktiv
                          </small>
                        </span>
                      ...
                      <div className="control-card-desc">
                        ...
                        <span className="sync-status-line" data-testid="bitunix-sync-status">
                          {syncStatus?.last_sync_at
                            ? <>Letzter Abgleich: <b>{new Date(syncStatus.last_sync_at).toLocaleString('de-DE')}</b>
                ...
                <div className="control-card" data-testid="control-watchdog-card">
                  <div className="control-card-header">
                    <div className="control-card-info">
                      ...
                      <div className="control-card-desc">
                        Prüft alle offenen Bitunix-Positionen: fehlende Stop-Losses werden
                        automatisch nachgezogen, unbekannte Positionen als „Extern (Watchdog)"
                        übernommen und in den offenen Trades angezeigt.
                        ...
                        <span className="sync-status-line" data-testid="watchdog-status">
                          {watchdogStatus?.last_run_at
                            ? <>Letzter Lauf: <b>{new Date(watchdogStatus.last_run_at).toLocaleString('de-DE')}</b>
