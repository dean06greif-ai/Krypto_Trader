  ...
  return (
    <div data-testid="ai-schedule-editor">
      ...
      <p className="gov-hint">
        Lege je Zeitfenster ein eigenes Intervall fest (Berlin-Zeit) – z.B. nachts alle 30 min,
        zur US-Eröffnung alle 5 min. Fenster über Mitternacht sind erlaubt; das erste passende
        Fenster gewinnt, sonst gilt das Standard-Intervall.
      </p>
