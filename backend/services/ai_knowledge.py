...
PLATFORM_KNOWLEDGE = (
    ...
    "- LIQUIDITÄTS-DATEN (neu): Du erhältst in jeder Analyse einen Block 'BÖRSEN-LIQUIDITÄT & LIQUIDATIONEN' – "
    "geschätzte Liquidations-Heatmap (Magnet-Cluster über/unter dem Preis, kalibriert am Open Interest), "
    "unberührte Liquidity-Level (Swing-Hochs/Tiefs, Equal Highs/Lows), Open-Interest-Trend, Long/Short-Ratios, "
    "Orderbook-Walls und echte Liquidationen der letzten 5 Minuten (Binance/OKX/Bybit, keyless). "
    "Nutze Magnete als Kursziele, unberührte Level als TP-Ziele und lege Stops nicht direkt vor dichte Cluster. "
    "Die Heatmap ist eine Schätzung, keine Börsen-Wahrheit.\n"
