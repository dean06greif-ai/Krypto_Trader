...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://regime-lab-enhanced.preview.emergentagent.com").rstrip("/")


@pytest.fixture(scope="session")
def token():
    r = requests.post(f"{BASE_URL}/api/auth/login", json={"username": "Admin", "password": "admin"}, timeout=15)
